...
public class EventPanel02 : MonoBehaviour, IUILayoutSerializable, IAdditionalDataProcessor
{
    public string GetDetailPrefabKey()
    {
        return "UI/EventPanels/EventPanel02/EventPanel02Detail";
    }
    ...
    {
        return "UI/EventPanels/EventPanel02/EventPanel02";
    }

    public string GetThumbnailPrefabKey()
    {
        return "UI/EventPanels/EventPanel02/EventPanel02DetailThumbnail";
    }
