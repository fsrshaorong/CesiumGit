...
public class EventPanel06 : MonoBehaviour, IUILayoutSerializable, IAdditionalDataProcessor
{
    public string GetDetailPrefabKey()
    {
        return "UI/EventPanels/EventPanel06/EventPanel06Detail";
    }
    ...
    {
        return "UI/EventPanels/EventPanel06/EventPanel06";
    }

    public string GetThumbnailPrefabKey()
    {
        return "UI/EventPanels/EventPanel06/EventPanel06DetailThumbnail";
    }
