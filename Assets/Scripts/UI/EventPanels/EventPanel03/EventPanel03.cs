...
public class EventPanel03 : MonoBehaviour, IUILayoutSerializable, IAdditionalDataProcessor
{
    public string GetDetailPrefabKey()
    {
        return "UI/EventPanels/EventPanel03/EventPanel03Detail";
    }
    ...
    {
        return "UI/EventPanels/EventPanel03/EventPanel03";
    }

    public string GetThumbnailPrefabKey()
    {
        return "UI/EventPanels/EventPanel03/EventPanel03DetailThumbnail";
    }
