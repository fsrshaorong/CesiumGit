...
public class EventPanel05 : MonoBehaviour, IUILayoutSerializable, IAdditionalDataProcessor
{
    public string GetDetailPrefabKey()
    {
        return "UI/EventPanels/EventPanel05/EventPanel05Detail";
    }
    ...
    {
        return "UI/EventPanels/EventPanel05/EventPanel05";
    }

    public string GetThumbnailPrefabKey()
    {
        return "UI/EventPanels/EventPanel05/EventPanel05DetailThumbnail";
    }
